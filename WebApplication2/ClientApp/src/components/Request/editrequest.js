...
export class EditRequest extends Component {
    ...
    constructor(props) {
        ...
        fetch('api/Request/getrequest/?id=' + this.state.id, {
            method: "GET",
            headers: {
            ...
            .then(data => {
                this.setState({
                    ...
                    roomscountmin: data.roomscountmin,
                    roomscountmax: data.roomscountmax,
                    floormin: data.floormin,
                    floormax: data.floormax,
                    floorscountmin: data.floorscountmin,
                    floorscountmax: data.floorscountmax,
                    typpe: data.typpeNavigation.id,
                    client: data.clientNavigation.id,
                    realtor: data.realtorNavigation.id,
                    status: data.statusNavigation.id,
                    loading: false
                });
            });
        ...
        if (!sessionStorage.getItem('Token')) {
            ...
            return (
                <div className="container col-sm-3">
                    <h1 className="col-sm-15">Редактировать заявку</h1>
                    <div>
                        <div>
